<template>
  <div style="text-align:left">
    ...
    <div class="form-group">
      ...
      <div class="col">
        <input type="text" class="form-control" v-model="proj.title" placeholder="Project Title" />
      </div>
    </div>
    <div class="form-group">
      <label for="desc" class="col-md-3 col-form-label">Description</label>
      <div class="col">
        <input type="text" class="form-control" v-model="proj.desc" placeholder="Description" />
      </div>
    </div>
    <div class="form-group">
      <label for="link" class="col-md-3 col-form-label">Link</label>
      <div class="col">
        <input type="url" class="form-control" v-model="proj.link" placeholder="Link" />
      </div>
    </div>
    <div class="form-group">
      <label for="start" class="col-md-3 col-form-label">Start</label>
      <div class="col">
        <input type="text" class="form-control" v-model="proj.start" placeholder="Jan 2020" />
      </div>
    </div>
    <div class="form-group">
